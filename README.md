...
```
 ...
 Once the ``Makefile`` is updated, please create an empty ``bin`` directory and simply run ``make`` and then add the path to the executables in the ``bin`` directory to your PATH. 
